...
public class TrendingDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        background_iv.setImageResource(R.drawable.jason);

        TextView name_txtview = findViewById(R.id.name_txtview);
        name_txtview.setText(getString(R.string.trending_name_tv));

        TextView title_txtview = findViewById(R.id.title_txtview);
        title_txtview.setText(getString(R.string.trending_title_tv));

        TextView time_txtview = findViewById(R.id.time_txtview);
        time_txtview.setText(getString(R.string.trending_time_tv));
